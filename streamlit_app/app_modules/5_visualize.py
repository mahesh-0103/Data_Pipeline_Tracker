...
def app():
    st.subheader("📈 Generated Reports and Download Center")
    st.markdown("---")
    ...
    if st.button("🖼️ Generate Full Report", type="primary"):
        ...
        with st.spinner(f"⏳ Generating full report using target column: **{target_col}**..."):
            report = full_report(df, target_col=target_col, train_runs=runs_safe) 
            
        st.success("✅ Report generated and saved to disk.")
